...
window.exportSemuaPendapatanBpjs = function (btn) {
    ...
    fetch(`/dashboard/pendapatan/bpjs?${params.toString()}`, {
        ...
        .then(res => {
            const data = res.data || [];
            let oldTable = document.getElementById('tempExportBpjs');
            if (oldTable) oldTable.remove();

            const table = document.createElement('table');
            table.id = 'tempExportBpjs';
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center">Jenis BPJS (REGULAR/EVAKUASI/OBAT)</th>
        ...
        `;
            ...
            previewExportExcel('tempExportBpjs', 'Data Laporan Pendapatan BPJS - Semua');

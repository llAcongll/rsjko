...
window.initPendapatanBpjs = function () {
    ...
    if (form) {
        ...
        form.querySelector('[name="no_sep"]').oninput = cekSiapSimpanBpjs;
        form.querySelector('[name="ruangan_id"]').onchange = cekSiapSimpanBpjs;
        form.querySelector('[name="bank"]').onchange = cekSiapSimpanBpjs;
        form.querySelector('[name="metode_detail"]').onchange = cekSiapSimpanBpjs;
        ...
        if (metodeSelect) {
            metodeSelect.onchange = () => {
                const bank = document.getElementById('bpjsBank');
                const detail = document.getElementById('bpjsMetodeDetail');

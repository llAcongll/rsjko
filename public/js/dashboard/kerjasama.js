...
window.exportSemuaPendapatanKerjasama = function (btn) {
    ...
    fetch(`/dashboard/pendapatan/kerjasama?${params.toString()}`, {
        ...
        .then(res => {
            const data = res.data || [];
            let oldTable = document.getElementById('tempExportKerjasama');
            if (oldTable) oldTable.remove();

            const table = document.createElement('table');
            table.id = 'tempExportKerjasama';
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center">MOU/Instansi</th>
        ...
        `;
            ...
            previewExportExcel('tempExportKerjasama', 'Data Laporan Pendapatan Kerjasama - Semua');

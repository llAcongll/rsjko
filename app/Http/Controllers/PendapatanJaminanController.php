...
class PendapatanJaminanController extends Controller
{
    ...
    {
        abort_unless(auth()->user()->hasPermission('PENDAPATAN_JAMINAN_VIEW') || auth()->user()->hasPermission('PENDAPATAN_JAMINAN') || auth()->user()->isAdmin(), 403);
    ...
    {
        abort_unless(auth()->user()->hasPermission('PENDAPATAN_JAMINAN_CREATE') || auth()->user()->hasPermission('PENDAPATAN_JAMINAN') || auth()->user()->isAdmin(), 403);
    ...
    {
        abort_unless(auth()->user()->hasPermission('PENDAPATAN_JAMINAN_DELETE') || auth()->user()->hasPermission('PENDAPATAN_JAMINAN') || auth()->user()->isAdmin(), 403);
        $pendapatan = PendapatanJaminan::findOrFail($id);

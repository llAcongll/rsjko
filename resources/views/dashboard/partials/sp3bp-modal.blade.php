<!-- Modal Tambah Periode SP3BP -->
<div id="newSp3bpModal" class="confirm-overlay">
    <div class="confirm-box" style="width: 400px; padding: 30px;">
        <div
            ...
            <h3 style="margin: 0; font-size: 18px; color: #0f172a;">Tambah Periode SP3BP</h3>
            <button type="button" onclick="closeSp3bpModal()"
        ...
        <div class="modal-body">
            ...
            <select id="newSp3bpTriwulan" class="filter-date-input"
            ...
            <div class="form-group" style="margin-bottom: 25px;">
                ...
                <input type="number" id="newSp3bpYear" class="filter-date-input" value="{{ date('Y') }}"
                    style="width: 100%; height: 42px; padding: 0 12px; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 14px;">
            </div>
        </div>
        <div style="display: flex; gap: 10px; justify-content: flex-end;">
            <button type="button" class="btn-secondary" onclick="closeSp3bpModal()"
            ...
            <button type="button" class="btn-filter" onclick="createSp3bpPeriod()"

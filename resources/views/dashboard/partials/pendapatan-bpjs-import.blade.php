<div id="modalImportBpjs" class="confirm-overlay">
    <div class="confirm-box" style="max-width: 480px;">
        <h3><i class="ph ph-upload-simple"></i> Import Data BPJS</h3>
        <p style="font-size: 13px; color: #64748b; margin-bottom: 16px;">
            Pastikan file menggunakan format CSV sesuai template. Data akan diproses masuk ke database.
        </p>

        <form id="formImportBpjs" enctype="multipart/form-data">
            ...
            <div class="confirm-actions">
                ...
                <button type="button" class="btn-secondary" onclick="closeModal('modalImportBpjs')">Batal</button>
            </div>
        </form>
    </div>
</div>
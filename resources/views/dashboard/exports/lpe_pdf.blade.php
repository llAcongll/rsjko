...
<body>
    <div class="title-container">
        ...
        <div style="font-size: 13pt; font-weight: bold; text-decoration: underline; margin: 4px 0;">LAPORAN PERUBAHAN
            EKUITAS</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>Surplus / (Defisit) Laporan Operasional</td>
                <td class="text-right">{{ number_format($surplus_defisit_lo, 2, ',', '.') }}</td>
            </tr>
            <tr>
                <td>Koreksi Nilai Ekuitas</td>

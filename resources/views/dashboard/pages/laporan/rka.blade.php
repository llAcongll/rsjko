<div class="laporan">
    <div class="laporan-header">
        <div class="header-left">
            ...
            <p>Pagu Anggaran Pendapatan dan Belanja Per Tahun</p>
        </div>
        <div class="header-right">
            <div class="laporan-filter-group">
                ...
                <button class="btn-filter" onclick="loadLaporan('RKA')">
                ...
                @if(auth()->user()->hasPermission('LAP_LRA_EXPORT') || auth()->user()->isAdmin())
                    ...
                    <button class="btn-preview" onclick="openPreviewModal('RKA')">
    ...
    <div id="rkaContent">
        <div style="text-align: center; padding: 100px 0; color: #94a3b8;">
            <i class="ph ph-article" style="font-size: 48pt; opacity: 0.2; margin-bottom: 16px; display: block;"></i>
